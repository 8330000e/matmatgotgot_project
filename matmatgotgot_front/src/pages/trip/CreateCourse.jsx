...
const CreateCourse = () => {
  ...
  const handleRestaurantClick = async (res) => {
    ...
    try {
      const response = await axios.get("/api/trips/create/menus", {
  ...
  const handleAddMenuSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("/api/trips/create/menu", formData, {
  ...
  const handleSubmitCourse = async () => {
    ...
    try {
      const response = await axios.post("/api/trips/create", payload);
  ...
  useEffect(() => {
    ...
    const delayDebounceTimer = setTimeout(async () => {
      try {
        const response = await axios.get("/api/trips/create/search", {
  ...
  useEffect(() => {
    const fetchTags = async () => {
      try {
        const response = await axios.get("/api/trips/create/tags");
